...
multi_search_web keys set searxng --value http://localhost:8899   # or: export SEARXNG_URL=http://localhost:8899
multi_search_web config set provider searxng                      # optional: try it first
```
